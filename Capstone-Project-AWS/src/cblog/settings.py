...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds2.cggidxy02owe.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'akaramanblog' # please enter your s3 bucket name
